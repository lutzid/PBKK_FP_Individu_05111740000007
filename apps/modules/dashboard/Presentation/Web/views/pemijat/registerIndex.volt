	...
	<div class="hero-static col-lg-6 col-xl-5">
		<div class="content content-full overflow-hidden">
			...
			<div class="py-20 text-center">
				<h1 class="h4 font-w700 mt-10 mb-10">Buat Akun Pemijat</h1>
			</div>
			<!-- END Header -->
			...
			<form class="js-validation-signup" action="{{url('register/pemijat')}}" method="post">
				<div class="block block-themed block-rounded block-shadow">
					...
					<div class="block-content bg-body-light">
						<div class="form-group text-center">
							...
							<a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="{{url('login/pemijat')}}">
